...
import { SubOrder, SubOrderDocument } from '@app/libs/common/schema';
...
export class StatisticsService {
  ...
  async getStaticSallerService(
        ...
        if (match) {
            return {
                ...
                summary: {
                    ...
                    totalPaid: match.totalSubTotal + match.totalShippingFee - match.totalRefund,
                },
            };
        } else {
            return {
    ...
    allSummary.totalPaid =
        allSummary.totalSubTotal + allSummary.totalShippingFee - allSummary.totalRefund;
